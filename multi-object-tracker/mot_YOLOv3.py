...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--video', '-v', type=str, default="./examples/video_data/Aeon_inout_movie3.mp4", help='Input video path.')

    parser.add_argument(
        '--weights', '-w', type=str,
        default="./examples/pretrained_models/yolo_weights/yolov3.weights",
        help='path to weights file of YOLOv3 (`.weights` file.)'
    )

    parser.add_argument(
        '--config', '-c', type=str,
        default="./examples/pretrained_models/yolo_weights/yolov3.cfg",
        help='path to config file of YOLOv3 (`.cfg` file.)'
    )

    parser.add_argument(
        '--labels', '-l', type=str,
        default="./examples/pretrained_models/yolo_weights/coco_names.json",
